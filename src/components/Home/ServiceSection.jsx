import { ClipboardList, Home, Users, Car, Heart, Calendar } from "lucide-react";
...
export default function ServiceSection() {
  return (
    <section
      ...
      className="relative bg-[#0b3a74] text-white py-16 md:py-24"
    >
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <br />
              <span className="text-white">Lead Their Best Lives</span>
            </h2>
            ...
            <div className="mt-8">
              <Link
                href="/services"
                className="inline-flex items-center rounded-full bg-white/10 px-6 py-3 text-base font-semibold text-white ring-1 ring-white/25 hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/80 transition-colors duration-200"
              >
                More Services
              </Link>
            </div>
...
function ServiceCard({ icon: Icon, title, desc }) {
  return (
    <article className="relative rounded-2xl border border-white/10 bg-white/5 p-8 shadow-[0_1px_0_0_rgba(255,255,255,0.05)_inset] ring-1 ring-white/10 backdrop-blur h-full flex flex-col">
      ...
      <h3 className="mt-6 text-xl font-extrabold leading-snug">{title}</h3>
      <p className="mt-3 text-sm leading-relaxed text-white/85 flex-grow">
        {desc}
      </p>
    </article>
  );
